...
int main()
{
    ...
    std::string clientId = "GXkDUGn_";
    std::string clientSecret = "x0lkHQ95AOZ7zFQF36id6UMXttqA2EdTeXrm82dB23k";
    ...
    if (!accessToken.empty())
    {
        ...
        do
        {
            ...
            case 1:
            {
                ...
                std::cin >> instrument;
                placeOrder(amount, accessToken, price, instrument);
                break;
            }
            case 2:
            {
        ...
        // placeOrder("500", accessToken, "10","ETH-PERPETUAL");
